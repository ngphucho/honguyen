          ...
          <Grid item md={9} sm={7} className="profile-box-right">
            ...
            <Card variant="outlined" className={classes.cardContainer}>
              ...
              <Typography sx={{ textAlign: "justify" }}>
                ...
                Facilis sint tenetur cumque officiis quidem accusamus laboriosam
                deleniti nihil perspiciatis totam ad possimus obcaecati
                consequuntur ullam nesciunt architecto ex, blanditiis aliquid
                dolorem a ratione quaerat? Voluptate iure, non soluta rem
                voluptatum sint quo, voluptatibus tempora eius doloribus eos
                ipsa quas accusamus?
              </Typography>
            </Card>
                  ...
                  <List>
                    <ListItem>
                      <ListItemAvatar>
                        <Avatar variant="square">
                          <Icon sx={{ textAlign: "center" }}>
                            <img src={ReactIcon} style={{ height: "100%" }} />
                          </Icon>
                        </Avatar>
                      </ListItemAvatar>
                    ...
                    <ListItem>
                      <ListItemAvatar>
                        <Avatar variant="square">
                          <Icon sx={{ textAlign: "center" }}>
                            <img src={AngularIcon} style={{ height: "100%" }} />
                          </Icon>
                        </Avatar>
                      </ListItemAvatar>
